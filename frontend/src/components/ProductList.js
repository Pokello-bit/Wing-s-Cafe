...
export default function ProductList() {
  ...
  const [form, setForm] = useState({ name: "", description: "", category: "", price: "", quantity: "", image: "" });
      ...
      <div className="product-grid">
        {products.map((p) => (
          <div key={p.id} className="product-card">
            <img src={p.image || "https://via.placeholder.com/150"} alt={p.name} className="product-image" />
            ...
            <div className="card-actions">
              <button className="btn small primary" onClick={() => startEdit(p)}>Edit</button>
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded w-96">
            ...
            <div className="edit-actions">
              <button className="btn small secondary" onClick={cancelEdit}>Cancel</button>
